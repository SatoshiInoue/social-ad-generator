# --- App Runner access role (used by App Runner to pull from ECR) ---
...
# --- App Runner instance role (used by the running container) ---
...
resource "aws_iam_openid_connect_provider" "github" {
  ...
  # GitHub's OIDC thumbprint (stable; see https://github.blog/changelog/2023-06-27-github-actions-update-on-oidc-integration-with-aws/)
